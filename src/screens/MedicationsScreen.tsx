...
export default function MedicationsScreen() {
  ...
  const inputClass = 'w-full border border-gray-200 rounded-xl px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal'
            ...
            {TIME_OF_DAY_OPTIONS.map((opt) => {
              ...
              return (
                ...
                >
                  ...
                  {opt.label}
                  {selected && (
                    <span className="ml-auto w-4 h-4 rounded-full bg-brand-teal flex items-center justify-center flex-shrink-0">
          ...
          <>
            ...
            <Card padding="sm">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-bold text-brand-teal">{takenCount}/{totalCount} taken</span>
              </div>
                        ...
                        <button
                          ...
                          className={[
                            ...
                            taken
                              ...
                              : isDueToday
                                ? 'border-gray-300 text-transparent hover:border-brand-teal active:scale-95'
                ...
                <div className="space-y-2">
                  {medications.map((med) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-3.5 border border-gray-200 rounded-xl hover:bg-brand-teal-light hover:border-indigo-300 transition text-sm font-medium text-gray-800"
                    >
                      {med.name}
                    </button>
                  ))}
